    ...
    <div className="about-editorial">
      <div className="about-hero-editorial">
        <div className="about-hero-content">
          <h1>My Journey as a Travel Curator</h1>
      ...
      <div className="about-content-editorial">
        <div className="placeholder-image-editorial portrait">Yuliya</div>
        <div className="about-text-editorial">
          ...
          <div className="mission-statement-editorial">
      ...
      <div className="philosophy-section-editorial">
        <div className="philosophy-content-editorial">
          <h2 className="section-title-philosophy">Travel Philosophy</h2>
          <div className="philosophy-grid-editorial">
            <div className="philosophy-card-editorial">
